...
検証ハーネスは `tools/harness/`(cam-probe / check-freeze / gait-harness / harness / harness-budget /
hazard-probe / legbal-probe / make-dev / release-sim / freecam-snippet。使い方は各ファイル冒頭コメント。
