...
export const PARTS = {
  ...
  wpn: [
    ...
    { id:'wp9', name:'ドリルアーム', desc:'回して穿つ。装甲は意味を失う。', kind:'drill',  band:'melee', dmg:128, range:9,  acc:0.74, cooldown:3.0, encost:20, projSpeed:0,   burst:1, breakPower:0.15, weight:140, price:1300,  tier:1 },
